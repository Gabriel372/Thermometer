...
setDeg(dataDeg)
console.log(`temperatura no rj ${deg}°c`)
})
...
<p><span>Madrugada: {dawn.status}</span><img src={dawn.img} alt='img'/></p>
</div>) : <Spinner/> }
</div>
}

export default RjCard